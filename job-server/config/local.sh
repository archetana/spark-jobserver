...
MANAGER_JAR_FILE="$INSTALL_DIR/spark-job-server.jar"
MANAGER_CONF_FILE="$INSTALL_DIR/local.sh"
MANAGER_EXTRA_JAVA_OPTIONS=
MANAGER_EXTRA_SPARK_CONFS=
MANAGER_LOGGING_OPTS="-Dlog4j.configuration=file:$INSTALL_DIR/log4j-server.properties"
